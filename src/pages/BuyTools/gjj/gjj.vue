<template>
  <div>
    <el-breadcrumb separator-class="el-icon-arrow-right" class="breadcrumb">
      ...
      <el-breadcrumb-item >公积金计算器</el-breadcrumb-item>
    </el-breadcrumb>
    <div class="content-banner">
      <img src="../../../common/img/hhjr.png" alt="hhjr" width="100%">
    </div>
    <span class="content-title">公积金计算器</span>
    <div class="content-paper">
      <p style="font-size:22px;color:#666666;margin-bottom:15px;">工具简介：</p>
      <p style="width:796px;height:40px;font-size:14px;line-height:22px;color:#666666;">公积金贷款计算器用于计算用户在申请公积金贷款时，选择等额本金和等额本息两种不同的还款方式后，每一期需偿还公积金贷款的月供，以及利息总额和还款总额。</p>
    </div>
          ...
          <el-form :model="ruleForm" :rules="rules" ref="ruleForm" label-width="100px" class="demo-ruleForm">
            ...
            <div v-if="ruleForm.type=='按贷款额度计算'">
              ...
              <el-form-item label="年利率：" prop="rate">
                <el-select v-model="ruleForm.rate" placeholder="请选择公积金率">
                  <el-option label="公积金基准利率(3.25%)" value="0.0325"></el-option>
                  <el-option label="公积金基准利率1.1倍(3.58%)" value="0.0358"></el-option>
                  <el-option label="公积金基准利率1.2倍(3.90%)" value="0.0390"></el-option>
                </el-select>
              </el-form-item>
