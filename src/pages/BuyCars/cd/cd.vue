<template>
  <div>
    <el-breadcrumb separator-class="el-icon-arrow-right" class="breadcrumb">
      ...
      <el-breadcrumb-item >车贷计算器</el-breadcrumb-item>
    </el-breadcrumb>
    <div class="content-banner">
      <img src="../../../common/img/hhjr.png" alt="hhjr" width="100%">
    </div>
    <span class="content-title">车贷计算器</span>
    <div class="content-paper">
      <p style="font-size:22px;color:#666666;margin-bottom:15px;">工具简介：</p>
      <p style="width:796px;height:40px;font-size:14px;line-height:22px;color:#666666;">车贷计算器用于计算办理汽车贷款时，在选择等额本金和等额本息两种不同的还款方式后，各自需要支出的月供，车贷利息总额和还款总额。</p>
    </div>
        ...
        <div class="shuju">
          <el-form :model="ruleForm" :rules="rules" ref="ruleForm" label-width="150px" class="demo-ruleForm">
            <el-form-item label="贷款金额：" prop="ed">
              <el-input v-model.number="ruleForm.ed">
